...
class MenuMakanan extends Component{
    ...
    pilihPesanan(value, e){
        this.setState({
            [value] : e.target.value, onChange:true
        })
    }
    nasipadang(){
        this.setState({
    ...
    render(){
        return(
            <div>
                ...
                <input type="number" value={this.state.jumlah} placeholder="Jumlah Pesanan" onChange={e => this.pilihPesanan("jumlah",e)}/>
                <button onClick={this.batal}>Batalkan Semua</button>
